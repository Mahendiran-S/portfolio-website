...
const DEFAULT_PROJECTS: SanityProject[] = PROJECTS.map((p) => ({
  ...
  liveUrl: p.liveUrl,
  thumbnailUrl: p.imageUrl ?? 'https://images.unsplash.com/photo-1555066931-4365d14bab8c?auto=format&fit=crop&w=1200&q=80',
  imageUrl: p.imageUrl ?? 'https://images.unsplash.com/photo-1555066931-4365d14bab8c?auto=format&fit=crop&w=1200&q=80',
  features: p.features,
