...
export function FigmaIcon({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
      <path d="M12 12c0-1.657 1.343-3 3-3s3 1.343 3 3-1.343 3-3 3-3-1.343-3-3zm-6 3c0-1.657 1.343-3 3-3h3v3a3 3 0 1 1-6 0zm0-6c0-1.657 1.343-3 3-3h3v6H9a3 3 0 0 1-3-3zm6-6h3a3 3 0 1 1 0 6h-3V3zm-3 0a3 3 0 0 0-3 3 3 3 0 0 0 3 3h3V3H9z"/>
    </svg>
  );
}
